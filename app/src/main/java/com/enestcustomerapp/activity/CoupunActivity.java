...
import com.enestcustomerapp.adepter.CouponAdp;
import com.enestcustomerapp.model.Coupon;
import com.enestcustomerapp.model.Couponlist;
    ...
    public void onClickItem(View v, Couponlist coupon) {
        try {
            if (amount >= coupon.getMinAmt() && quantity >= coupon.getMinQuan()) {
                ...
                Toast.makeText(CoupunActivity.this, "Sorry, this coupon code cannot be applied", Toast.LENGTH_LONG).show();
            }

        ...
        new Handler().postDelayed(() -> {
            if (Utiles.internetChack()) {
                if (sessionManager.getBooleanData(SessionManager.login)) {
                    ...
                    ActivityOptions option = ActivityOptions.makeSceneTransitionAnimation(FirstActivity.this, pair);
                    startActivity(new Intent(FirstActivity.this, LoginActivity.class), option.toBundle());
                } else {

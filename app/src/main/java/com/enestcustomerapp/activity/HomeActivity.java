...
import com.enestcustomerapp.fragment.AddressFragment;
import com.enestcustomerapp.fragment.CardFragment;
import com.enestcustomerapp.fragment.HomeFragment;
import com.enestcustomerapp.fragment.ItemListFragment;
import com.enestcustomerapp.fragment.MyOrderFragment;
import com.enestcustomerapp.fragment.OrderSumrryFragment;
...
import static com.enestcustomerapp.fragment.ItemListFragment.itemListFragment;
import static com.enestcustomerapp.fragment.OrderSumrryFragment.isorder;
...
import static com.enestcustomerapp.utils.SessionManager.login;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private void shareApp() {
        try {
            ...
            String shareMessage = "\nHaving trouble buying groceries? E-Nest provides you with a variety of daily utilities to choose from. Ranging from fresh fruits to farm fresh veggies, we've got you covered.\n\n";
    ...
    @SuppressLint("SetTextI18n")
    @OnClick({R.id.img_close, R.id.myprofile, R.id.myoder, R.id.address, R.id.feedback, R.id.contect, R.id.call, R.id.logout, R.id.about, R.id.privecy, R.id.img_search, R.id.img_cart, R.id.img_noti, R.id.img_call, R.id.lvl_home, R.id.share, R.id.termcondition})

...
import com.enestcustomerapp.model.MyOrder;
import com.enestcustomerapp.model.Productinfo;
...
import static com.enestcustomerapp.utils.Utiles.isrates;
        ...
        try {
            if (callNo.equalsIgnoreCase("1")) {
                ...
                if (myOrder.getResult().equals("true")) {
                    ...
                    item.setVisible(myOrder.getmIsrated().equalsIgnoreCase("No") && myOrder.getStatus().equalsIgnoreCase("completed"));
                    itemC.setVisible(myOrder.getStatus().equalsIgnoreCase("processing") || myOrder.getStatus().equalsIgnoreCase(getResources().getString(R.string.pic_myslf)));
                    if (myOrder.getpMethod().equalsIgnoreCase(getResources().getString(R.string.pic_myslf))) {
    ...
    private void setOrderList(LinearLayout lnrView, List<Productinfo> list) {
        ...
        if (list != null && list.size() > 0) {
            for (int i = 0; i < list.size(); i++) {
                ...
                a = a + 1;
                @SuppressLint("InflateParams") View view = inflater.inflate(R.layout.custome_myoder, null);

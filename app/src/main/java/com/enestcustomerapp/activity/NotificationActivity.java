...
import com.enestcustomerapp.model.Noti;
import com.enestcustomerapp.model.ResNoti;
    ...
    private void setNotiList(LinearLayout lnrView, List<Noti> list) {
        ...
        if (list != null && list.size() > 0) {
            for (int i = 0; i < list.size(); i++) {
                ...
                a = a + 1;
                @SuppressLint("InflateParams") View view = inflater.inflate(R.layout.custome_noti, null);
                ...
                lvl_bgcolor.setOnClickListener(v -> {
                    noti.setiSread(1);

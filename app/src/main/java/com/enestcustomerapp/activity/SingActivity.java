...
import com.enestcustomerapp.model.CCode;
import com.enestcustomerapp.model.Contry;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_tandp:
                ...
                ActivityOptions option = ActivityOptions.makeSceneTransitionAnimation(SingActivity.this, pair);
                startActivity(new Intent(SingActivity.this, TramsAndConditionActivity.class), option.toBundle());
                break;
            default:
                break;
        }

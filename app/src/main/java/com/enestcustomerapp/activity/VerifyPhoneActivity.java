...
import com.enestcustomerapp.model.LoginUser;
...
import static com.enestcustomerapp.utils.Utiles.isvarification;
...
public class VerifyPhoneActivity extends AppCompatActivity implements GetResult.MyListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_send:
                if (validation()) {
                    verifyCode(Objects.requireNonNull(edOtp1.getText()).toString() + "" + Objects.requireNonNull(edOtp2.getText()).toString() + "" + Objects.requireNonNull(edOtp3.getText()).toString() + "" + Objects.requireNonNull(edOtp4.getText()).toString() + "" + Objects.requireNonNull(edOtp5.getText()).toString() + "" + Objects.requireNonNull(edOtp6.getText()).toString());
                }
                break;

...
public class CategoryAdp extends RecyclerView.Adapter<CategoryAdp.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.thumbnail.setOnClickListener(v -> listener.onClickItem(category.getCatname(), Integer.parseInt(category.getId())));
    }
    ...
    public interface RecyclerTouchListener {
        void onClickItem(String titel, int position);

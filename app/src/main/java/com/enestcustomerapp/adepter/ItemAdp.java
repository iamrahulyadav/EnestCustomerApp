package com.enestcustomerapp.adepter;
...
import com.enestcustomerapp.model.Price;
...
public class ItemAdp extends RecyclerView.Adapter<ItemAdp.ViewHolder> {
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int position) {
        ...
        holder.imgIcon.setOnClickListener(v -> mContext.startActivity(new Intent(mContext, ItemDetailsActivity.class).putExtra("MyClass", datum).putParcelableArrayListExtra("MyList", datum.getPrice())));
    ...
    private void setJoinPlayrList(LinearLayout lnrView, ProductItem datum, Price price) {
        ...
        @SuppressLint("InflateParams") View view = inflater.inflate(R.layout.custome_prize, null);

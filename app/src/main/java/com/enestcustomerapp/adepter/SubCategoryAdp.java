...
import com.enestcustomerapp.model.SubcatItem;
...
public class SubCategoryAdp extends RecyclerView.Adapter<SubCategoryAdp.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.thumbnail.setOnClickListener(v -> listener.onClickItem(v, Integer.parseInt(category.getCatId()), Integer.parseInt(category.getId())));
    }
    ...
    public interface RecyclerTouchListener {
        void onClickItem(View v, int cid, int scid);

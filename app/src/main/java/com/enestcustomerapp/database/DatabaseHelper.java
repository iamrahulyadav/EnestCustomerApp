package com.enestcustomerapp.database;
...
import static com.enestcustomerapp.activity.HomeActivity.txt_countcard;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private int getID(String pid, String cost) {
        SQLiteDatabase db = this.getWritableDatabase();
        @SuppressLint("Recycle") Cursor c = db.query(TABLE_NAME, new String[]{"PID"}, "PID =? AND cost =? ", new String[]{pid, cost}, null, null, null, null);
    ...
    public int getCard(String pid, String cost) {
        SQLiteDatabase db = this.getWritableDatabase();
        @SuppressLint("Recycle") Cursor c = db.query(TABLE_NAME, new String[]{"qty"}, "PID =? AND cost =? ", new String[]{pid, cost}, null, null, null, null);
        if (c.moveToFirst()) { //if the row exist then return the id
